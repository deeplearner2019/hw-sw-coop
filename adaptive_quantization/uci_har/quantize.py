...
def _FindLayersToQuantize(graph):
  ...
  final_layer_pattern = graph_matcher.OpTypePattern(
      '|'.join(_QUANTIZABLE_TYPES),
      inputs=[
          input_pattern,
          graph_matcher.OneofPattern([
  ...
  # print ('post_activation_bypass_layer_matcher')
  ...
  final_layer_matcher = graph_matcher.GraphMatcher(
      graph_matcher.OneofPattern([layer_pattern, bias_add_pattern, folded_bias_add_pattern]))
  # print ('final_layer_matcher')
