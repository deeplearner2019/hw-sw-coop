...
tf.app.flags.DEFINE_string(
    'dataset_dir', '/home/nvidia/dataset/cifar10', 'The directory where the dataset files are stored.')
...
def main(model_name, case, measure_dir, N, F):
    ...
    with open(os.path.join(measure_dir, model_name + '_final_{}_{}.txt'.format(N, F)), 'w') as fp:
        json.dump(dico, fp)
...
if __name__ == "__main__":
    ...
    main(model_name, case, measure_dir, N, F)
