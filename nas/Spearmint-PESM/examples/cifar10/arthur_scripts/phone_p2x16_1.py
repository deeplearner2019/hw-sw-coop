...
public_DNS = 'ec2-54-157-198-102.compute-1.amazonaws.com'
...
def lock_instance_gpu(command,filename,file_to_get_back):
    ...
    cmd_s = '#!/bin/bash\n(flock -w 3600 9 || exit 1; cd {0}/movidius; export PYTHONPATH={0}/movidius:$PYTHONPATH;python {1}; sleep 5) 9>/var/lock/p28_1'.format(PATH_TO_HACONE,python_file)
