...
It commands to train a given model in the first GPU, ie number 8.
"""
import ssm
import buckets
import json
...
public_DNS = 'ec2-18-205-28-206.compute-1.amazonaws.com'
...
def main(job_id, params):
    ...
    command.append("./train_eval_image_classifier_bis.py 8 {} --max_number_of_steps=28125".format(job_id))
    print(command)
