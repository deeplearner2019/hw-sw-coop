...
It commands to train a given model in the first GPU, ie number 12.
"""
import ssm
import buckets
import json
...
def main(job_id, params):
    ...
    command.append("./train_eval_image_classifier_bis.py 12 {} --max_number_of_steps=28125".format(job_id))
    print(command)
