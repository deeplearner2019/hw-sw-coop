...
It commands to train a given model in the first GPU, ie number 7.
"""
import ssm
import buckets
import json
...
instance_id = 'i-045a4efbd7ed9dfff' #p2.8xlarge
public_DNS = 'ec2-54-87-142-14.compute-1.amazonaws.com'
...
def listen_to_remote_process(file_path):
    ...
    while True:
        ...
        if exists_remote(file_path) or timer > 200:
            break
...
def main(job_id, params):
    ...
    command.append("./train_eval_image_classifier_bis.py 7 {} --max_number_of_steps=28125".format(job_id))
    print(command)
