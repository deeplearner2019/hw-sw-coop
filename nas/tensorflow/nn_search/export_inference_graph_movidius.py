...
tf.app.flags.DEFINE_string(
    'PATH_TO_HACONE', '/mnt/data_b/anne-maelle/hacone', 'The path to the hacone directory.')
...
tf.app.flags.DEFINE_string(
    'name_job','_0_-1_6_5_2_0_3_-2_-2_-2_-2_6_-2_-1_5_0_1_5_3_7','Name of the job in the format _1_2_3_4_ etc.')

tf.app.flags.DEFINE_string(
    'output_file','','Where to save the resulting file to')

tf.app.flags.DEFINE_string(
    'dataset_dir', FLAGS.PATH_TO_HACONE+'/dataset/cifar10', 'Directory to save intermediate dataset files to')


def main(_):

  with open('{}/jobs/job{}.txt'.format(FLAGS.PATH_TO_HACONE,FLAGS.name_job), 'r') as fp:
      data = json.load(fp)
  job_id = data['job']
  params = data['params']
