...
def tile_anchors(grid_height,
  ...
  #zhao bin
  #heights = tf.constant([64, 64, 32, 128, 128, 64, 256, 256, 128, 512, 512, 256], dtype=tf.float32) 
  #widths = tf.constant([32, 64, 64, 64, 128, 128, 128, 256, 256, 256, 512, 512], dtype=tf.float32) 
  
  #xuhong
  heights = tf.constant([88, 64, 44, 176, 128, 88, 352, 256, 176, 704, 512, 352], dtype=tf.float32) 
  widths = tf.constant([44, 64, 88, 88, 128, 176, 176, 256, 352, 352, 512, 704], dtype=tf.float32) 
