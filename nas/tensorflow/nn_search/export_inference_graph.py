...
output_dir = os.path.join('outputs', tf.app.flags.FLAGS.job_name)
output_file = os.path.join(output_dir, 'inference_graph')
tf.app.flags.DEFINE_string(
    'output_file', output_file, 'Where to save the resulting file to.')

tf.app.flags.DEFINE_string(
    'dataset_dir', '/home/lile/dataset/cifar10', 'Directory to save intermediate dataset files to')
