...
class Arguments:
    def __init__(self, network, inputnode, outputnode, outfile, inputsize, nshaves, weights, explicit_concat, model_dir, extargs):
...
if __name__ == "__main__":
    ...
    args = parse_args()
    create_graph(args.network, args.inputnode, args.outputnode, args.outfile, args.nshaves, args.inputsize, args.weights, args.explicit_concat, args.ma2480, args.scheduler, args.model_dir, args)
