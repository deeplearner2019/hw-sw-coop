...
def main(_):
  ...
  model_settings = models.prepare_model_settings(
      ...
      FLAGS.window_stride_ms, FLAGS.feature_bin_count, FLAGS.preprocess,FLAGS.first_h,FLAGS.first_w,FLAGS.second_h,FLAGS.second_w,
      FLAGS.third_h,FLAGS.third_w,FLAGS.layers)
  ...
  isTraining=tf.placeholder(tf.bool,name='train_bool')
  ...
  with tf.name_scope('cross_entropy'):
    ...
    loss = tf.losses.get_regularization_loss()+ cross_entropy_mean
  ...
  with tf.name_scope('train'), tf.control_dependencies(control_dependencies):
    ...
    learning_rate= tf.train.exponential_decay(learning_rate_input,global_step,100,0.98)
